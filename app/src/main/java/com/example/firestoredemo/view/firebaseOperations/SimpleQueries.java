 ...
 * In this class we are using whereEqualTo, whereGreaterThanOrEqualTo ,orderBy and limits query
 */

public class SimpleQueries extends AppCompatActivity {
    private EditText editTitle, editDesc, editPriority;
    private TextView noteTextView;
    public static final String QUERY_TABLE_NAME = "Queries Table";
    private CollectionReference noteCollRef = FirebaseFirestore.getInstance()
            .collection(QUERY_TABLE_NAME);

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_simple_quries);
        ...
        noteCollRef.whereEqualTo("priority", 1)
                .addSnapshotListener(new EventListener<QuerySnapshot>() {
                    ...
                    public void onEvent(@Nullable QuerySnapshot queryDocumentSnapshots, @Nullable FirebaseFirestoreException e) {
                        ...
                        if (e != null) {
                            Toast.makeText(SimpleQueries.this, "Failed to add listener", Toast.LENGTH_SHORT).show();
                            return;
                        }
                        ...
                        if (queryDocumentSnapshots != null) {
                            for (QueryDocumentSnapshot documentSnapshot : queryDocumentSnapshots) {
                                ...
                                data.append("Title ").append(noteModel.getTitle())
                                        .append("\nDescription ")
                                        .append(noteModel.getDescription())
                                        .append("\nPriority ")
                                        .append(noteModel.getPriority())
                                        .append("\n\n");
                            }
                        }
        ...
        noteCollRef.add(model)
                .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                    ...
                    public void onSuccess(DocumentReference documentReference) {
                        Toast.makeText(SimpleQueries.this, "Added successfully", Toast.LENGTH_SHORT).show();
                    }
                }).addOnFailureListener(new OnFailureListener() {
            @Override
            public void onFailure(@NonNull Exception e) {
                e.printStackTrace();
                Toast.makeText(SimpleQueries.this, "Failed to add", Toast.LENGTH_SHORT).show();
    ...
    public void loadNote(View view) {
        noteCollRef
            ...
            public void onFailure(@NonNull Exception e) {
                e.printStackTrace();
                Toast.makeText(SimpleQueries.this, "Failed to load data", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
